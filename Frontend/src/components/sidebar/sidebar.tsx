...
const Sidebar: React.FC = () => {
  const menuItems: MenuItem[] = [
    ...
    // { path: '/search', label: 'Búsqueda General', icon: <svg className={styles.icon} ... /> },
  ];

  const bottomMenuItems: MenuItem[] = [
    // Si quieres un ABM de pedidos separado de la vista de dashboard:
    // { path: '/pedidos-admin', label: 'Admin Pedidos', icon: <svg className={styles.icon} ... /> },
    {
      path: '/productos',
      label: 'Productos',
  ...
  // El JSX para renderizar los NavLink permanece igual, solo se actualizan los datos de los arrays.
  // ... (resto del return JSX del Sidebar) ...
  return (
