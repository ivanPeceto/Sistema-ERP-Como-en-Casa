...
const CrearEditarCobroModal: React.FC<CrearEditarCobroModalProps> = ({
  ...
  }, [isOpen, editingCobro, pedidoId, montoRestante]);
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    const dataToSubmit: CobroInput = {
      ...
      banco: ['debito', 'credito', 'mercadopago'].includes(formData.tipo) ? formData.banco : undefined,
      referencia: ['debito', 'credito', 'mercadopago'].includes(formData.tipo) ? formData.referencia : undefined,
      cuotas: formData.tipo === 'credito' ? (formData.cuotas ? Number(formData.cuotas) : undefined) : undefined,
    };
