...
import createAuthApiClient from './apiClient'; // Importa tu función factoría

// Obtenemos las URLs base desde las variables de entorno
...
// Creamos y exportamos una instancia de API para cada microservicio
