...
class PedidoProductos(models.Model):
    id_pedido = models.ForeignKey("apps.pedidos.Pedido", db_column=("id_pedido"), on_delete=models.CASCADE)
    ...
    nombre_producto = models.CharField(max_lenght=100, db_column='nombre_producto')
